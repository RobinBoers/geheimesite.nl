                ...
                if(isset($email) && $email !== "") {
                    ...
                    if($conn->query("UPDATE userinfo SET token='$token' WHERE id = '$row->id'")) {
                        ...
                        if(mail($email,"Wachtwoord voor \"geheimesite.nl\" opnieuw instellen",$msg)) {
                            ...
                            <p>
                                <b>Oeps!</b><br>
                                Er is iets foutgegaan bij het versturen van de email. Neem contact op met de beheerder via <a href="mailto:robin@geheimesite.nl">robin@geheimesite.nl</a>. EMAIL_SERVER_FAILED<br>
                                <a href="index.php">OK</a>
                            </p>
                            <?php
                        }
                        ...
                        ?>
                            <p>
                                <b>Oeps!</b><br>
                                Er is iets foutgegaan bij het versturen van de email. Neem contact op met de beheerder via <a href="mailto:robin@geheimesite.nl">robin@geheimesite.nl</a>. TOKEN_CHANGE_FAILED<br>
                                <a href="index.php">OK</a>
                            </p>
                        <?php
                    }                    
