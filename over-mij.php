        ...
        <main id="content" class="page-content">
            <article>
                ...
                <section>
                    ...
                    <p>
                        Wil je me een bericht sturen?<br />Dit is een van mijn 6 e-mailadressen: <a href="mailto:robin@geheimesite.nl">robin@geheimesite.nl</a><br />
                        Je kunt ook het onderstaande contactformulier invullen.
                    </p>
                    <form action="scripts/contact-form.php" method="post">
                        <input class="input" type="text" name="email" placeholder="Emailadres..." />
