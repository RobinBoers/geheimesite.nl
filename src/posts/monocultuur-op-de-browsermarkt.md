...
- [Google is breaking the web to rebuild it in their own image.](//yewtu.be/watch?v=P39Buvpzjaw)
...
[^2]: Zie hier een StackOverflow post van andere programmeurs die er last van hadden: [JavaScript dialogs alert(), confirm() and prompt() in cross origin iframe does not work any longer](//stackoverflow.com/questions/68492434/javascript-dialogs-alert-confirm-and-prompt-in-cross-origin-iframe-does-n)

[^3]: Ondanks de gelijkenis met Blink en Chromium

[^4]: Een artikel over de recente problemen van Firefox: [As Mozilla talks up Firefox’s future, the present is killing it](//computerworld.com/article/3628338/as-mozilla-talks-up-firefoxs-future-the-present-is-killing-it.html)
