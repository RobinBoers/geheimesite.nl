...
Ik ben bezig met het lezen van [<cite>This is how they tell me the world ends</cite>](//www.bibliotheek.nl/catalogus/titel.434364606.html/this-is-how-they-tell-me-the-world-ends/). Het gaat over hoe regeringen kritieke bugs in software (zero-days) kopen en exploiteren om toegang te krijgen tot data waar we geen toestemming voor hebben. Het zette me aan het denken over privacy en data op het internet.
...
Zo maakt dit blog nu gebruik van [Chop](https://git.dupunkto.org/~axcelott/chop) en GitHub Pages. Ik heb al mijn content als Markdown files op mijn laptop staan in een Git repo. Ik kan de Git repo nu makkelijk naar een andere code forge zoals Codeberg of GitLab verplaatsen en de site bij een andere provider deployen. Ik ben daardoor niet meer afhankelijk van Blogger[^1].
