...
<head>
    ...
    <link rel="stylesheet" href="/website/v/15/assets/css/main.css" title="default" />
    <script defer src="/website/v/15/assets/js/menu.js"></script>
    ...
    <header class="pageheader mb-4">
        <nav class="mt-4">
            ...
            <ul class="menu">
                ...
                <li><a href="/website/v/15/over-mij">Over mij</a></li>
                <li><a href="/website/v/15/projecten">Projecten</a></li>
                <li><a href="/website/v/15/boeken">Boeken</a></li>
